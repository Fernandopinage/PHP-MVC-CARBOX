                                ...
                                <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="text" class="form-control form-control-sm is-invalid" id="sap" name="sap" placeholder="" value="<?php echo $obj->getSap(); ?>" disabled>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <input type="hidden" class="form-control form-control-sm is-invalid" id="unidade" name="unidade" placeholder="" value="<?php echo $obj->getUnidade(); ?>">
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
