                    ...
                    <div class="row" style="margin-top: 150px; text-align: center;">
                        <div class="col-sm">
                            <div>
                                ...
                                <h3 class="font-weight-light">Para efetuar o primeiro acesso  <a href="http://localhost/carbox/app/php/acesso.php"> click no link </a> entre com seu e-mail <strong><i>'.$email.'  </i><strong> e utilize o código para alterar sua senha <strong style="color:#FF5E14;">' . $rash . '</strong></h3>
                            </div>
                        </div>
                    </div>
