                    ...
                    <div class="row" style="margin-top: 150px; text-align: center;">
                        <div class="col-sm">
                            <div>
                                ...
                                <h3 class="font-weight-light">Não se preocupe, acontece com todo mundo. Para redenifir sua senha, <a href="https://sistema.carboxigases.com/app/php/alterarsenha_adm.php?email='.$email.'&senha='.$rash.'"><b style="color:#136132;">Click aqui</b></a>:</h3>
                            </div>
                        </div>
                    </div>
