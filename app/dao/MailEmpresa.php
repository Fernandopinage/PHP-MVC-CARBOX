                    ...
                    <div class="row" style="margin-top: 150px; text-align: center;">
                        <div class="col-sm">
                            <div>
                                ...
                                <h3 class="font-weight-light">Olá, seu pedido foi realizado com sucesso, número do seu protocolo é <b style="color:#FF5E14;">'.$ClassProduto->getNum().'</b></h3>
                                <h3> O pedido foi realizando pelo colaborador <b style="color:#136132;"> ' . $cliente . '</b></h3>
