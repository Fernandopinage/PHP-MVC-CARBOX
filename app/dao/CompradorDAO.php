...
class CompradorDAO extends DAO{
    ...
    public function inserComprador(ClassComprador $ClassComprador){
        ...
        $sql = "INSERT INTO `comprador`(`COMPRADOR_ID`, `COMPRADOR_CNPJ`, `COMPRADOR_NOME`, `COMPRADOR_EMAIL`, `COMPRADOR_SENHA`) VALUES (null, :COMPRADOR_CNPJ, :COMPRADOR_NOME, :COMPRADOR_EMAIL, :COMPRADOR_SENHA)";

        $insert = $this->con->prepare($sql);
        $insert->bindValue(":COMPRADOR_CNPJ", $ClassComprador->getCnpj());
        $insert->bindValue(":COMPRADOR_NOME", $ClassComprador->getNome());
        $insert->bindValue(":COMPRADOR_EMAIL", $ClassComprador->getCnpj());
