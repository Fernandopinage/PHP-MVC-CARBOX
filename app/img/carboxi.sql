...
--
-- Host: localhost:3306
-- Tempo de geração: 03-Ago-2021 às 09:25
...
(1, '004.963.342-20', 'Razão Social', '', 'suporte@progride.com.br', 1, 'S');
...
(1, '004.963.342-20', 'luiz fernando', 'luiz.c@progride.com.br', '63a9f0ea7bb98050796b649e85481845', 'Ativo', 'S');
...
(1, '', '', 'Oxigênio Medicinal ', '3', '2021-08-02', '2', '02', 3386502),
(2, '', '', 'Misturas para solda - Carbomix ', '2', '2021-08-02', '2', '08', 3386502),
(3, '', '', 'Dióxido de Carbono Industrial ', '6', '2021-08-02', '2', '06', 9864302),
(4, '', '', 'Oxigênio Industrial ', '1', '2021-08-02', '2', '01', 9864302);
...
--
ALTER TABLE `comprador`
  MODIFY `COMPRADOR_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
